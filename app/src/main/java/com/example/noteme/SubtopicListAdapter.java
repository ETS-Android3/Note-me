...
public class SubtopicListAdapter extends ArrayAdapter<Subtopic> {
    public SubtopicListAdapter(Context context, ArrayList<Subtopic> topicArrayList) {
